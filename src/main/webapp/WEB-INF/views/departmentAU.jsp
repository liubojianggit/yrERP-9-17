...
<form:form class="layui-form" style="width:80%;" id="form2" method="POST" modelAttribute="department">
    <form:errors path="*"></form:errors>
    <c:if test="${departmentbo.department.id != null }">
        <input type="hidden" name="_method" value="PUT"/>
        <input type="hidden" name="id" value="${departmentbo.department.getId() }">
    </c:if>
    ...
    <div class="magb15 layui-col-md4 layui-form-item layui-col-xs12">
        ...
        <div class="layui-input-inline">
            <form:select path="department.pid" id="pidSelect" items="${supDepartment }" itemLabel="department.name" itemValue="department.id"></form:select>
        </div>
    </div>
